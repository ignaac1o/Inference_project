...
data_smallcar$PriceinGermany=log(data_smallcar$PriceinGermany)
data_bigcar$PriceinGermany=log(data_bigcar$PriceinGermany)
...
*for this part we are using the original data instead of log_transformed data because we don't care about the distribution, maybe we can consider this as a nonparametric interpretation
