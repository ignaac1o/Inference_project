...
we are not having the true distribution of the price in population, plus we don't know the true mean value and the  variance. So we decide to use the method of the pivotal quantity for $\mu$
